...
"[project]/src/app/dashboard/card/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '@/api/apiRoutes'");
...
function CardPage() {
    ...
    const [newTitle, setNewTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const fetchCards = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(API.cards.byUser("me")); // "me" sẽ được backend hiểu là người đang đăng nhập
            setCards(res.data);
        } catch (err) {
    ...
    const handleAddCard = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(API.cards.add, {
                name: newTitle,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 h-full flex flex-col bg-purple-300 rounded-lg",
        children: [
...
//# sourceMappingURL=src_app_8373cef3._.js.map