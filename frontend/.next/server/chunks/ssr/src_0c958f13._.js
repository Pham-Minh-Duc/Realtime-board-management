...
const taskService = {
    ...
    create: async (cardId, payload)=>{
        const res = await apiClient.post(API.tasks.byCard(cardId), payload);
        return res.data;
    },
    ...
    assign: async (cardId, taskId, memberId)=>{
        const res = await apiClient.post(API.tasks.assign(cardId, taskId), {
            memberId
        });
        return res.data;
    },
...
//# sourceMappingURL=src_0c958f13._.js.map