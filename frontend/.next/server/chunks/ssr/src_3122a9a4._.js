...
const API = {
    ...
    card: {
        ...
        update: (id)=>`/cards/${id}`,
        delete: (id)=>`/cards/${id}`,
        byUser: (userId)=>`/cards/users/${userId}`,
...
const taskService = {
    getByCard: async (cardId)=>{
        const res = await apiClient.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.byCard(cardId));
        return res.data;
    },
    create: async (cardId, payload)=>{
        const res = await apiClient.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.byCard(cardId), payload);
        return res.data;
    },
    update: async (cardId, taskId, payload)=>{
        const res = await apiClient.put(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.byId(cardId, taskId), payload);
        return res.data;
    },
    patch: async (cardId, taskId, payload)=>{
        const res = await apiClient.patch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.byId(cardId, taskId), payload);
        return res.data;
    },
    remove: async (cardId, taskId)=>{
        const res = await apiClient.delete(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.byId(cardId, taskId));
        return res.data;
    },
    assign: async (cardId, taskId, memberId)=>{
        const res = await apiClient.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.assign(cardId, taskId), {
            memberId
        });
        return res.data;
    },
    getAttachments: async (cardId, taskId)=>{
        const res = await apiClient.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.attachments(cardId, taskId));
        return res.data;
    },
    attachGitHub: async (cardId, taskId, payload)=>{
        const res = await apiClient.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].tasks.attach(cardId, taskId), payload);
        return res.data;
    }
};
...
function CardDetailPage() {
    const [isForcused, setIsForcused] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    useEffect(()=>{
        if (!cardId) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$taskService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getByCard(cardId).then((data)=>setTasks(data)).catch((err1)=>console.error("Error loading tasks:", err1));
    }, [
        cardId
    ]);
    const handleAddTask = ()=>{
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                isForcused && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=src_3122a9a4._.js.map