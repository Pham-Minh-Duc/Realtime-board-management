...
function SignInPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].signin(form);
            if (result) {
                ...
                alert("Đăng nhập thành công! Xin chào ".concat(result.user.name));
                setTimeout(()=>{
            ...
            setError(((_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.error) || "Đăng nhập thất bại!");
        }
    };
    const handleGithubLogin = async ()=>{
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"])("github"); // redirect đến GitHub
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SignInPage, "+yHNKhdAE+P7cXVS3TCtHpXDMBQ=", false, function() {
    return [
...
//# sourceMappingURL=src_f318a7ee._.js.map