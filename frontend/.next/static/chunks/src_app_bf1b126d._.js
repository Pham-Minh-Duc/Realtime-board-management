...
function CardPage() {
    ...
    const [newTitle, setNewTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const fetchCards = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(API.cards.byUser("me")); // "me" sẽ được backend hiểu là người đang đăng nhập
            setCards(res.data);
        } catch (err) {
    ...
    const handleAddCard = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(API.cards.add, {
                name: newTitle,
...
_s(CardPage, "HeAp0cLBspeRvrd0WlgglUCdENc=", false, function() {
    return [
...
//# sourceMappingURL=src_app_bf1b126d._.js.map